...
do
  ...
  sed "s/<target>/$TARGET/" qiime_import_deblur_denoise_job.sb > qiime_import_deblur_denoise_job_"$TARGET"_"$REGION"_"$LAYOUT".sb
  sed -i "s/<region>/$REGION/" qiime_import_deblur_denoise_job_"$TARGET"_"$REGION"_"$LAYOUT".sb
  sed -i "s/<layout>/$LAYOUT/" qiime_import_deblur_denoise_job_"$TARGET"_"$REGION"_"$LAYOUT".sb
  sbatch qiime_import_deblur_denoise_job_"$TARGET"_"$REGION"_"$LAYOUT".sb
